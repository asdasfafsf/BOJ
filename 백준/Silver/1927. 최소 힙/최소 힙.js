class ProrityQueue {
    ...
    pop = () => {
        ...
        while( (left < this.heap.length && this.heap[left] < this.heap[cur])
             || (right < this.heap.length && this.heap[right] < this.heap[cur])) {

            let target = left

            if (this.heap[left] && this.heap[right]) {
                target = this.heap[left] < this.heap[right] ? left : right;
            }
